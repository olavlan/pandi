...
-spec inline_to_lustre_with(
    pandi@pandoc:inline(),
    fun((pandi@pandoc:inline(), list({binary(), binary()})) -> gleam@option:option(lustre@vdom@vnode:element(AEEV))),
    list({binary(), binary()})
) -> lustre@vdom@vnode:element(AEEV).
...
-spec list_items_to_lustre(
    ...
    fun((pandi@pandoc:block(), list({binary(), binary()})) -> gleam@option:option(lustre@vdom@vnode:element(AEFG))),
    fun((pandi@pandoc:inline(), list({binary(), binary()})) -> gleam@option:option(lustre@vdom@vnode:element(AEFG))),
    list({binary(), binary()})
) -> list(lustre@vdom@vnode:element(AEFG)).
...
-spec block_to_lustre_with(
    pandi@pandoc:block(),
    fun((pandi@pandoc:block(), list({binary(), binary()})) -> gleam@option:option(lustre@vdom@vnode:element(AEER))),
    fun((pandi@pandoc:inline(), list({binary(), binary()})) -> gleam@option:option(lustre@vdom@vnode:element(AEER))),
    list({binary(), binary()})
) -> lustre@vdom@vnode:element(AEER).
...
-spec blocks_to_lustre_with(
    ...
    fun((pandi@pandoc:block(), list({binary(), binary()})) -> gleam@option:option(lustre@vdom@vnode:element(AEEJ))),
    fun((pandi@pandoc:inline(), list({binary(), binary()})) -> gleam@option:option(lustre@vdom@vnode:element(AEEJ))),
    list({binary(), binary()})
) -> lustre@vdom@vnode:element(AEEJ).
...
-spec to_lustre_with(
    ...
    fun((pandi@pandoc:block(), list({binary(), binary()})) -> gleam@option:option(lustre@vdom@vnode:element(AEEE))),
    fun((pandi@pandoc:inline(), list({binary(), binary()})) -> gleam@option:option(lustre@vdom@vnode:element(AEEE)))
) -> lustre@vdom@vnode:element(AEEE).
...
-spec inlines_to_lustre_with(
    ...
    fun((pandi@pandoc:inline(), list({binary(), binary()})) -> gleam@option:option(lustre@vdom@vnode:element(AEEO))),
    list({binary(), binary()})
) -> lustre@vdom@vnode:element(AEEO).
