...
-spec element(
    list(lustre@vdom@vattr:attribute(AARB)),
    list(lustre@vdom@vnode:element(AARB))
) -> lustre@vdom@vnode:element(AARB).
...
-spec include(lustre@vdom@vattr:attribute(AARN), list(binary())) -> lustre@vdom@vattr:attribute(AARN).
...
-spec subject(lustre:runtime(AARR)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(AARR)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(AARZ))
) -> lustre@runtime@server@runtime:message(AARZ).
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(AASD))
) -> lustre@runtime@server@runtime:message(AASD).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(AASH)) -> nil)
) -> lustre@runtime@server@runtime:message(AASH).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(AASK)) -> nil)
) -> lustre@runtime@server@runtime:message(AASK).
...
-spec select(
    fun((fun((AASP) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(AASP))
) -> lustre@effect:effect(AASP).
select(Sel) ->
