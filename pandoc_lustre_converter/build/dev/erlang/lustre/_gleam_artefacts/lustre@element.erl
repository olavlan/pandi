...
-spec element(
    binary(),
    list(lustre@vdom@vattr:attribute(SED)),
    list(lustre@vdom@vnode:element(SED))
) -> lustre@vdom@vnode:element(SED).
...
-spec namespaced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(SEJ)),
    list(lustre@vdom@vnode:element(SEJ))
) -> lustre@vdom@vnode:element(SEJ).
...
-spec advanced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(SEP)),
    list(lustre@vdom@vnode:element(SEP)),
    boolean(),
    boolean()
) -> lustre@vdom@vnode:element(SEP).
...
-spec fragment(list(lustre@vdom@vnode:element(SEZ))) -> lustre@vdom@vnode:element(SEZ).
fragment(Children) ->
...
-spec memo(
    ...
    fun(() -> lustre@vdom@vnode:element(SFI))
) -> lustre@vdom@vnode:element(SFI).
...
-spec map(lustre@vdom@vnode:element(SFM), fun((SFM) -> SFO)) -> lustre@vdom@vnode:element(SFO).
map(Element, F) ->
