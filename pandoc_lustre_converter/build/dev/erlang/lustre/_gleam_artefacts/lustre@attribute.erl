...
-file("src/lustre/attribute.gleam", 893).
?DOC(
    " A positive integer value indicating how many visible columns the text control\n"
    " will have. The default value is 20.\n"
).
-spec cols(integer()) -> lustre@vdom@vattr:attribute(any()).
cols(Value) ->
    attribute(<<"cols"/utf8>>, erlang:integer_to_binary(Value)).

-file("src/lustre/attribute.gleam", 911).
?DOC(
...
-file("src/lustre/attribute.gleam", 930).
...
-file("src/lustre/attribute.gleam", 942).
?DOC(
...
-file("src/lustre/attribute.gleam", 951).
?DOC(
...
-file("src/lustre/attribute.gleam", 960).
?DOC(
...
-file("src/lustre/attribute.gleam", 969).
?DOC(
...
-file("src/lustre/attribute.gleam", 978).
?DOC(
...
-file("src/lustre/attribute.gleam", 1018).
?DOC(
...
-file("src/lustre/attribute.gleam", 1033).
?DOC(
...
-file("src/lustre/attribute.gleam", 1049).
?DOC(
    " Minimum value\n"
    "\n"
    " The following input types support the `\"max\"` attribute:\n"
...
-file("src/lustre/attribute.gleam", 1062).
?DOC(
...
-file("src/lustre/attribute.gleam", 1079).
...
-file("src/lustre/attribute.gleam", 1092).
?DOC(
...
-file("src/lustre/attribute.gleam", 1106).
?DOC(
...
-file("src/lustre/attribute.gleam", 1119).
?DOC(
...
-file("src/lustre/attribute.gleam", 1132).
?DOC(
...
-file("src/lustre/attribute.gleam", 1180).
?DOC(
...
rows(Value) ->
    attribute(<<"rows"/utf8>>, erlang:integer_to_binary(Value)).
...
-file("src/lustre/attribute.gleam", 1202).
?DOC(
...
-file("src/lustre/attribute.gleam", 1217).
?DOC(
    " Size of the control\n"
    "\n"
...
-file("src/lustre/attribute.gleam", 1233).
?DOC(
...
-file("src/lustre/attribute.gleam", 1251).
?DOC(
...
-file("src/lustre/attribute.gleam", 1264).
?DOC(
...
-file("src/lustre/attribute.gleam", 1273).
?DOC(
...
-file("src/lustre/attribute.gleam", 1308).
?DOC(
...
-file("src/lustre/attribute.gleam", 1315).
?DOC(
...
-file("src/lustre/attribute.gleam", 1322).
?DOC(
...
-file("src/lustre/attribute.gleam", 1329).
?DOC(
...
-file("src/lustre/attribute.gleam", 1340).
?DOC(
...
-file("src/lustre/attribute.gleam", 1347).
?DOC(
...
-file("src/lustre/attribute.gleam", 1360).
?DOC(
...
-file("src/lustre/attribute.gleam", 1386).
?DOC(
...
-file("src/lustre/attribute.gleam", 1393).
?DOC(
...
-file("src/lustre/attribute.gleam", 1411).
?DOC(
...
-file("src/lustre/attribute.gleam", 1419).
?DOC(
...
-file("src/lustre/attribute.gleam", 1426).
?DOC(
...
-file("src/lustre/attribute.gleam", 1456).
?DOC(
...
-spec datetime(binary()) -> lustre@vdom@vattr:attribute(any()).
datetime(Value) ->
    attribute(<<"datetime"/utf8>>, Value).

-file("src/lustre/attribute.gleam", 1484).
?DOC(
...
-file("src/lustre/attribute.gleam", 1506).
?DOC(
...
-file("src/lustre/attribute.gleam", 1518).
?DOC(
...
-file("src/lustre/attribute.gleam", 1525).
?DOC(
...
-file("src/lustre/attribute.gleam", 1533).
?DOC(
...
-file("src/lustre/attribute.gleam", 1551).
?DOC(
...
-file("src/lustre/attribute.gleam", 1558).
?DOC(
...
-file("src/lustre/attribute.gleam", 1565).
?DOC(
...
-file("src/lustre/attribute.gleam", 1572).
?DOC(
...
-file("src/lustre/attribute.gleam", 1579).
?DOC(
...
-file("src/lustre/attribute.gleam", 1594).
?DOC(
...
-file("src/lustre/attribute.gleam", 1608).
?DOC(
...
-file("src/lustre/attribute.gleam", 1615).
?DOC(
...
-file("src/lustre/attribute.gleam", 1622).
?DOC(
...
-file("src/lustre/attribute.gleam", 1632).
?DOC(
...
-file("src/lustre/attribute.gleam", 1640).
?DOC(
...
-file("src/lustre/attribute.gleam", 1652).
?DOC(
...
-file("src/lustre/attribute.gleam", 1677).
?DOC(
...
-file("src/lustre/attribute.gleam", 1684).
?DOC(
...
-file("src/lustre/attribute.gleam", 1691).
?DOC(
...
-file("src/lustre/attribute.gleam", 1705).
?DOC(
...
-file("src/lustre/attribute.gleam", 1713).
?DOC(
...
-file("src/lustre/attribute.gleam", 1719).
...
-file("src/lustre/attribute.gleam", 1729).
?DOC(
...
-file("src/lustre/attribute.gleam", 1739).
?DOC(
...
-file("src/lustre/attribute.gleam", 1757).
?DOC(
...
-file("src/lustre/attribute.gleam", 1765).
?DOC(
...
-file("src/lustre/attribute.gleam", 1773).
?DOC(
...
-file("src/lustre/attribute.gleam", 1780).
?DOC(
...
-file("src/lustre/attribute.gleam", 1787).
?DOC(
...
-file("src/lustre/attribute.gleam", 1815).
?DOC(
...
-file("src/lustre/attribute.gleam", 1822).
?DOC(
...
-file("src/lustre/attribute.gleam", 1860).
?DOC(
...
-file("src/lustre/attribute.gleam", 1867).
?DOC(
...
-file("src/lustre/attribute.gleam", 1874).
?DOC(
...
-file("src/lustre/attribute.gleam", 1881).
?DOC(
...
-file("src/lustre/attribute.gleam", 1887).
...
-file("src/lustre/attribute.gleam", 1894).
?DOC(
