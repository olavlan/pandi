...
-type client_message(TTA) :: {mount,
        ...
        lustre@vdom@vnode:element(TTA),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TTA)), lustre@vdom@vnode:element(TTA))} |
    {reconcile,
        integer(),
        lustre@vdom@patch:patch(TTA),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TTA)), lustre@vdom@vnode:element(TTA))} |
...
-spec mount(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(TTG),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TTG)), lustre@vdom@vnode:element(TTG))
) -> client_message(TTG).
mount(
    Open_shadow_root,
    Will_adopt_styles,
...
?DOC(false).
-spec reconcile(
    lustre@vdom@patch:patch(TTK),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TTK)), lustre@vdom@vnode:element(TTK))
) -> client_message(TTK).
...
-spec reconcile_to_json(
    integer(),
    lustre@vdom@patch:patch(TUD),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TUD)), lustre@vdom@vnode:element(TUD))
) -> gleam@json:json().
...
-spec mount_to_json(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(TUA),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TUA)), lustre@vdom@vnode:element(TUA))
) -> gleam@json:json().
mount_to_json(
    Kind,
    Open_shadow_root,
