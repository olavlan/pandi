...
-spec fold_clauses(
    ...
    scope(),
    KPB,
    fun((KPB, scope(), glance:expression()) -> KPB)
) -> KPB.
...
-spec fold_expressions(
    ...
    scope(),
    KPD,
    fun((KPD, scope(), glance:expression()) -> KPD)
) -> KPD.
...
-spec fold_fields(
    ...
    scope(),
    KOZ,
    fun((KOZ, scope(), glance:expression()) -> KOZ)
) -> KOZ.
...
-spec fold_expression(
    ...
    scope(),
    KOW,
    fun((KOW, scope(), glance:expression()) -> KOW)
) -> KOW.
...
-spec fold_statements(
    ...
    scope(),
    KOV,
    fun((KOV, scope(), glance:expression()) -> KOV)
) -> KOV.
