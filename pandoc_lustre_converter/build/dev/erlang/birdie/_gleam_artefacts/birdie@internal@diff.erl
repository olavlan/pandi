...
-type occurs(LIB) :: {one, integer(), list(LIB), list(LIB)} |
    {other, integer(), list(LIB), list(LIB)} |
    {both, integer(), list(LIB), list(LIB), list(LIB), list(LIB)}.
...
-file("src/birdie/internal/diff.gleam", 176).
?DOC(false).
-spec sum_occurrences(occurs(LJI), occurs(LJI)) -> occurs(LJI).
...
-file("src/birdie/internal/diff.gleam", 152).
?DOC(false).
-spec histogram_add(
    gleam@dict:dict(LIW, occurs(LIW)),
    list(LIW),
    fun((integer(), list(LIW), list(LIW)) -> occurs(LIW)),
    list(LIW)
) -> gleam@dict:dict(LIW, occurs(LIW)).
...
-file("src/birdie/internal/diff.gleam", 123).
?DOC(false).
-spec lowest_occurrence_common_item(list(LIO), list(LIO)) -> gleam@option:option({LIO,
    integer(),
    list(LIO),
    list(LIO),
    list(LIO),
...
-file("src/birdie/internal/diff.gleam", 202).
?DOC(false).
-spec do_pop_common_prefix(list(LJS), list(LJS), list(LJS)) -> {list(LJS),
    list(LJS),
    list(LJS)}.
...
-file("src/birdie/internal/diff.gleam", 217).
?DOC(false).
-spec pop_common_suffix(list(LJZ), list(LJZ)) -> {list(LJZ),
    list(LJZ),
    list(LJZ)}.
...
-file("src/birdie/internal/diff.gleam", 194).
?DOC(false).
-spec pop_common_prefix(list(LJM), list(LJM)) -> {list(LJM),
    list(LJM),
    list(LJM)}.
...
-file("src/birdie/internal/diff.gleam", 76).
?DOC(false).
-spec lcs(list(LIK), list(LIK)) -> list(LIK).
lcs(One, Other) ->
