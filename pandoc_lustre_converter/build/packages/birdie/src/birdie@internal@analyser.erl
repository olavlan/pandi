...
-spec fold_clauses(
    ...
    scope(),
    KJR,
    fun((KJR, scope(), glance:expression()) -> KJR)
) -> KJR.
...
-spec fold_expressions(
    ...
    scope(),
    KJT,
    fun((KJT, scope(), glance:expression()) -> KJT)
) -> KJT.
...
-spec fold_fields(
    ...
    scope(),
    KJP,
    fun((KJP, scope(), glance:expression()) -> KJP)
) -> KJP.
...
-spec fold_expression(
    ...
    scope(),
    KJM,
    fun((KJM, scope(), glance:expression()) -> KJM)
) -> KJM.
...
-spec fold_statements(
    ...
    scope(),
    KJL,
    fun((KJL, scope(), glance:expression()) -> KJL)
) -> KJL.
