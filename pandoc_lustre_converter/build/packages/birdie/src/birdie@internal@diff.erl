...
-type occurs(LCR) :: {one, integer(), list(LCR), list(LCR)} |
    {other, integer(), list(LCR), list(LCR)} |
    {both, integer(), list(LCR), list(LCR), list(LCR), list(LCR)}.
...
?DOC(false).
-spec sum_occurrences(occurs(LDY), occurs(LDY)) -> occurs(LDY).
...
?DOC(false).
-spec histogram_add(
    gleam@dict:dict(LDM, occurs(LDM)),
    list(LDM),
    fun((integer(), list(LDM), list(LDM)) -> occurs(LDM)),
    list(LDM)
) -> gleam@dict:dict(LDM, occurs(LDM)).
...
?DOC(false).
-spec lowest_occurrence_common_item(list(LDE), list(LDE)) -> gleam@option:option({LDE,
    integer(),
    list(LDE),
    list(LDE),
    list(LDE),
...
?DOC(false).
-spec do_pop_common_prefix(list(LEI), list(LEI), list(LEI)) -> {list(LEI),
    list(LEI),
    list(LEI)}.
...
?DOC(false).
-spec pop_common_suffix(list(LEP), list(LEP)) -> {list(LEP),
    list(LEP),
    list(LEP)}.
...
?DOC(false).
-spec pop_common_prefix(list(LEC), list(LEC)) -> {list(LEC),
    list(LEC),
    list(LEC)}.
...
?DOC(false).
-spec lcs(list(LDA), list(LDA)) -> list(LDA).
lcs(One, Other) ->
