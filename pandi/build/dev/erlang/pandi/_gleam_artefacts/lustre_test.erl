...
-define(FILEPATH, "test/lustre_test.gleam").
-export([lustre_test/0]).
-export_type([resource/0]).

-type resource() :: {resource, binary(), binary()}.

-file("test/lustre_test.gleam", 16).
...
-file("test/lustre_test.gleam", 31).
...
-file("test/lustre_test.gleam", 38).
...
-file("test/lustre_test.gleam", 47).
