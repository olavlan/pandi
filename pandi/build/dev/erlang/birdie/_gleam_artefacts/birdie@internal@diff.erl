...
-type occurs(HAS) :: {one, integer(), list(HAS), list(HAS)} |
    {other, integer(), list(HAS), list(HAS)} |
    {both, integer(), list(HAS), list(HAS), list(HAS), list(HAS)}.
...
?DOC(false).
-spec sum_occurrences(occurs(HBZ), occurs(HBZ)) -> occurs(HBZ).
...
?DOC(false).
-spec histogram_add(
    gleam@dict:dict(HBN, occurs(HBN)),
    list(HBN),
    fun((integer(), list(HBN), list(HBN)) -> occurs(HBN)),
    list(HBN)
) -> gleam@dict:dict(HBN, occurs(HBN)).
...
?DOC(false).
-spec lowest_occurrence_common_item(list(HBF), list(HBF)) -> gleam@option:option({HBF,
    integer(),
    list(HBF),
    list(HBF),
    list(HBF),
...
?DOC(false).
-spec do_pop_common_prefix(list(HCJ), list(HCJ), list(HCJ)) -> {list(HCJ),
    list(HCJ),
    list(HCJ)}.
...
?DOC(false).
-spec pop_common_suffix(list(HCQ), list(HCQ)) -> {list(HCQ),
    list(HCQ),
    list(HCQ)}.
...
?DOC(false).
-spec pop_common_prefix(list(HCD), list(HCD)) -> {list(HCD),
    list(HCD),
    list(HCD)}.
...
?DOC(false).
-spec lcs(list(HBB), list(HBB)) -> list(HBB).
lcs(One, Other) ->
