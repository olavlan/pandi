...
-spec element(
    binary(),
    list(lustre@vdom@vattr:attribute(IUJ)),
    list(lustre@vdom@vnode:element(IUJ))
) -> lustre@vdom@vnode:element(IUJ).
...
-spec namespaced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(IUP)),
    list(lustre@vdom@vnode:element(IUP))
) -> lustre@vdom@vnode:element(IUP).
...
-spec fragment(list(lustre@vdom@vnode:element(IVF))) -> lustre@vdom@vnode:element(IVF).
fragment(Children) ->
...
-spec unsafe_raw_html(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(IVJ)),
    binary()
) -> lustre@vdom@vnode:element(IVJ).
...
-spec memo(
    ...
    fun(() -> lustre@vdom@vnode:element(IVO))
...
-spec map(lustre@vdom@vnode:element(IVS), fun((IVS) -> IVU)) -> lustre@vdom@vnode:element(IVU).
map(Element, F) ->
