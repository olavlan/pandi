...
-spec find_matching_in_list(
    list(lustre@vdom@vnode:element(OBK)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(OBK), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    lustre@vdom@vnode:element(OBF),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(OBF), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant_in_list(
    ...
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(OBV), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    lustre@vdom@vnode:element(OBQ),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(OBQ), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_list(
    list(lustre@vdom@vnode:element(OAZ)),
    'query'(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(OAZ), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(OAU),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(OAU), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_path(
    ...
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(OAP), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(OAK), 'query'()) -> {ok,
        lustre@vdom@vnode:element(OAK)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_all_direct_children(lustre@vdom@vnode:element(OCO), selector()) -> list(lustre@vdom@vnode:element(OCO)).
...
-spec find_all_descendants_in_list(
    list(lustre@vdom@vnode:element(ODB)),
    selector()
) -> list(lustre@vdom@vnode:element(ODB)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(OCX), selector()) -> list(lustre@vdom@vnode:element(OCX)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(OCJ)), 'query'()) -> list(lustre@vdom@vnode:element(OCJ)).
...
-spec find_all_in_children(lustre@vdom@vnode:element(OCF), 'query'()) -> list(lustre@vdom@vnode:element(OCF)).
...
-spec find_all(lustre@vdom@vnode:element(OCB), 'query'()) -> list(lustre@vdom@vnode:element(OCB)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
            case matches(Root, Selector) of
