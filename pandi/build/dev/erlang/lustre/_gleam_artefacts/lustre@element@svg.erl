...
?DOC("\n").
-spec animate(list(lustre@vdom@vattr:attribute(PIX))) -> lustre@vdom@vnode:element(PIX).
animate(Attrs) ->
...
?DOC("\n").
-spec animate_motion(list(lustre@vdom@vattr:attribute(PJB))) -> lustre@vdom@vnode:element(PJB).
...
?DOC("\n").
-spec animate_transform(list(lustre@vdom@vattr:attribute(PJF))) -> lustre@vdom@vnode:element(PJF).
...
?DOC("\n").
-spec mpath(list(lustre@vdom@vattr:attribute(PJJ))) -> lustre@vdom@vnode:element(PJJ).
mpath(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"mpath"/utf8>>,
...
?DOC("\n").
-spec set(list(lustre@vdom@vattr:attribute(PJN))) -> lustre@vdom@vnode:element(PJN).
set(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"set"/utf8>>,
...
?DOC("\n").
-spec circle(list(lustre@vdom@vattr:attribute(PJR))) -> lustre@vdom@vnode:element(PJR).
circle(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"circle"/utf8>>,
...
?DOC("\n").
-spec ellipse(list(lustre@vdom@vattr:attribute(PJV))) -> lustre@vdom@vnode:element(PJV).
ellipse(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"ellipse"/utf8>>,
...
?DOC("\n").
-spec line(list(lustre@vdom@vattr:attribute(PJZ))) -> lustre@vdom@vnode:element(PJZ).
line(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"line"/utf8>>,
...
?DOC("\n").
-spec polygon(list(lustre@vdom@vattr:attribute(PKD))) -> lustre@vdom@vnode:element(PKD).
polygon(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"polygon"/utf8>>,
...
?DOC("\n").
-spec polyline(list(lustre@vdom@vattr:attribute(PKH))) -> lustre@vdom@vnode:element(PKH).
polyline(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"polyline"/utf8>>,
...
?DOC("\n").
-spec rect(list(lustre@vdom@vattr:attribute(PKL))) -> lustre@vdom@vnode:element(PKL).
rect(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"rect"/utf8>>,
...
?DOC("\n").
-spec a(
    list(lustre@vdom@vattr:attribute(PKP)),
    list(lustre@vdom@vnode:element(PKP))
) -> lustre@vdom@vnode:element(PKP).
a(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"a"/utf8>>,
...
?DOC("\n").
-spec defs(
    list(lustre@vdom@vattr:attribute(PKV)),
    list(lustre@vdom@vnode:element(PKV))
) -> lustre@vdom@vnode:element(PKV).
defs(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"defs"/utf8>>,
...
?DOC("\n").
-spec g(
    list(lustre@vdom@vattr:attribute(PLB)),
    list(lustre@vdom@vnode:element(PLB))
) -> lustre@vdom@vnode:element(PLB).
g(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"g"/utf8>>,
...
?DOC("\n").
-spec mask(
    list(lustre@vdom@vattr:attribute(PLN)),
    list(lustre@vdom@vnode:element(PLN))
) -> lustre@vdom@vnode:element(PLN).
mask(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"mask"/utf8>>,
...
?DOC("\n").
-spec missing_glyph(
    list(lustre@vdom@vattr:attribute(PLT)),
    list(lustre@vdom@vnode:element(PLT))
) -> lustre@vdom@vnode:element(PLT).
...
?DOC("\n").
-spec pattern(
    list(lustre@vdom@vattr:attribute(PLZ)),
    list(lustre@vdom@vnode:element(PLZ))
) -> lustre@vdom@vnode:element(PLZ).
...
?DOC("\n").
-spec svg(
    list(lustre@vdom@vattr:attribute(PMF)),
    list(lustre@vdom@vnode:element(PMF))
) -> lustre@vdom@vnode:element(PMF).
svg(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"svg"/utf8>>,
...
?DOC("\n").
-spec switch(
    list(lustre@vdom@vattr:attribute(PML)),
    list(lustre@vdom@vnode:element(PML))
) -> lustre@vdom@vnode:element(PML).
...
?DOC("\n").
-spec view(
    list(lustre@vdom@vattr:attribute(PMX)),
    list(lustre@vdom@vnode:element(PMX))
) -> lustre@vdom@vnode:element(PMX).
view(Attrs, Children) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"view"/utf8>>,
...
?DOC("\n").
-spec metadata(
    list(lustre@vdom@vattr:attribute(PNJ)),
    list(lustre@vdom@vnode:element(PNJ))
) -> lustre@vdom@vnode:element(PNJ).
...
?DOC("\n").
-spec title(
    list(lustre@vdom@vattr:attribute(PNP)),
    list(lustre@vdom@vnode:element(PNP))
) -> lustre@vdom@vnode:element(PNP).
...
?DOC("\n").
-spec fe_blend(list(lustre@vdom@vattr:attribute(POB))) -> lustre@vdom@vnode:element(POB).
fe_blend(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feBlend"/utf8>>,
...
?DOC("\n").
-spec fe_color_matrix(list(lustre@vdom@vattr:attribute(POF))) -> lustre@vdom@vnode:element(POF).
...
?DOC("\n").
-spec fe_component_transfer(list(lustre@vdom@vattr:attribute(POJ))) -> lustre@vdom@vnode:element(POJ).
...
?DOC("\n").
-spec fe_composite(list(lustre@vdom@vattr:attribute(PON))) -> lustre@vdom@vnode:element(PON).
fe_composite(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feComposite"/utf8>>,
...
?DOC("\n").
-spec fe_convolve_matrix(list(lustre@vdom@vattr:attribute(POR))) -> lustre@vdom@vnode:element(POR).
...
?DOC("\n").
-spec fe_displacement_map(list(lustre@vdom@vattr:attribute(PPB))) -> lustre@vdom@vnode:element(PPB).
...
?DOC("\n").
-spec fe_drop_shadow(list(lustre@vdom@vattr:attribute(PPF))) -> lustre@vdom@vnode:element(PPF).
...
?DOC("\n").
-spec fe_flood(list(lustre@vdom@vattr:attribute(PPJ))) -> lustre@vdom@vnode:element(PPJ).
fe_flood(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feFlood"/utf8>>,
...
?DOC("\n").
-spec fe_func_a(list(lustre@vdom@vattr:attribute(PPN))) -> lustre@vdom@vnode:element(PPN).
fe_func_a(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feFuncA"/utf8>>,
...
?DOC("\n").
-spec fe_func_b(list(lustre@vdom@vattr:attribute(PPR))) -> lustre@vdom@vnode:element(PPR).
fe_func_b(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feFuncB"/utf8>>,
...
?DOC("\n").
-spec fe_func_g(list(lustre@vdom@vattr:attribute(PPV))) -> lustre@vdom@vnode:element(PPV).
fe_func_g(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feFuncG"/utf8>>,
...
?DOC("\n").
-spec fe_func_r(list(lustre@vdom@vattr:attribute(PPZ))) -> lustre@vdom@vnode:element(PPZ).
fe_func_r(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feFuncR"/utf8>>,
...
?DOC("\n").
-spec fe_gaussian_blur(list(lustre@vdom@vattr:attribute(PQD))) -> lustre@vdom@vnode:element(PQD).
...
?DOC("\n").
-spec fe_image(list(lustre@vdom@vattr:attribute(PQH))) -> lustre@vdom@vnode:element(PQH).
fe_image(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feImage"/utf8>>,
...
?DOC("\n").
-spec fe_merge_node(list(lustre@vdom@vattr:attribute(PQR))) -> lustre@vdom@vnode:element(PQR).
fe_merge_node(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feMergeNode"/utf8>>,
...
?DOC("\n").
-spec fe_morphology(list(lustre@vdom@vattr:attribute(PQV))) -> lustre@vdom@vnode:element(PQV).
fe_morphology(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feMorphology"/utf8>>,
...
?DOC("\n").
-spec fe_offset(list(lustre@vdom@vattr:attribute(PQZ))) -> lustre@vdom@vnode:element(PQZ).
fe_offset(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feOffset"/utf8>>,
...
?DOC("\n").
-spec fe_turbulence(list(lustre@vdom@vattr:attribute(PRP))) -> lustre@vdom@vnode:element(PRP).
fe_turbulence(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feTurbulence"/utf8>>,
...
?DOC("\n").
-spec stop(list(lustre@vdom@vattr:attribute(PSF))) -> lustre@vdom@vnode:element(PSF).
stop(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"stop"/utf8>>,
...
?DOC("\n").
-spec image(list(lustre@vdom@vattr:attribute(PSJ))) -> lustre@vdom@vnode:element(PSJ).
image(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"image"/utf8>>,
...
?DOC("\n").
-spec path(list(lustre@vdom@vattr:attribute(PSN))) -> lustre@vdom@vnode:element(PSN).
path(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"path"/utf8>>,
...
?DOC("\n").
-spec text(list(lustre@vdom@vattr:attribute(PSR)), binary()) -> lustre@vdom@vnode:element(PSR).
text(Attrs, Content) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"text"/utf8>>,
...
?DOC("\n").
-spec use_(list(lustre@vdom@vattr:attribute(PSV))) -> lustre@vdom@vnode:element(PSV).
use_(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"use"/utf8>>,
...
?DOC("\n").
-spec fe_distant_light(list(lustre@vdom@vattr:attribute(PSZ))) -> lustre@vdom@vnode:element(PSZ).
...
?DOC("\n").
-spec fe_point_light(list(lustre@vdom@vattr:attribute(PTD))) -> lustre@vdom@vnode:element(PTD).
...
?DOC("\n").
-spec fe_spot_light(list(lustre@vdom@vattr:attribute(PTH))) -> lustre@vdom@vnode:element(PTH).
fe_spot_light(Attrs) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"feSpotLight"/utf8>>,
...
?DOC("\n").
-spec script(list(lustre@vdom@vattr:attribute(PTR)), binary()) -> lustre@vdom@vnode:element(PTR).
script(Attrs, Js) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"script"/utf8>>,
...
?DOC("\n").
-spec style(list(lustre@vdom@vattr:attribute(PTV)), binary()) -> lustre@vdom@vnode:element(PTV).
style(Attrs, Css) ->
    lustre@element:namespaced(
        <<"http://www.w3.org/2000/svg"/utf8>>,
        <<"style"/utf8>>,
