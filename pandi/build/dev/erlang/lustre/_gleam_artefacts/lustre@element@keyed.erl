...
-spec do_extract_keyed_children(
    list({binary(), lustre@vdom@vnode:element(OZZ)}),
    lustre@internals@mutable_map:mutable_map(binary(), lustre@vdom@vnode:element(OZZ)),
...
-spec extract_keyed_children(list({binary(), lustre@vdom@vnode:element(OZR)})) -> {lustre@internals@mutable_map:mutable_map(binary(), lustre@vdom@vnode:element(OZR)),
    list(lustre@vdom@vnode:element(OZR))}.
...
-spec element(
    binary(),
    list(lustre@vdom@vattr:attribute(OXX)),
    list({binary(), lustre@vdom@vnode:element(OXX)})
) -> lustre@vdom@vnode:element(OXX).
...
-spec namespaced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(OYD)),
    list({binary(), lustre@vdom@vnode:element(OYD)})
...
-spec fragment(list({binary(), lustre@vdom@vnode:element(OYJ)})) -> lustre@vdom@vnode:element(OYJ).
fragment(Children) ->
    {Keyed_children, Children@1} = extract_keyed_children(Children),
...
-spec ul(
    list(lustre@vdom@vattr:attribute(OYN)),
    list({binary(), lustre@vdom@vnode:element(OYN)})
) -> lustre@vdom@vnode:element(OYN).
ul(Attributes, Children) ->
    element(<<"ul"/utf8>>, Attributes, Children).

-file("src/lustre/element/keyed.gleam", 145).
-spec ol(
    list(lustre@vdom@vattr:attribute(OYT)),
    list({binary(), lustre@vdom@vnode:element(OYT)})
) -> lustre@vdom@vnode:element(OYT).
ol(Attributes, Children) ->
    element(<<"ol"/utf8>>, Attributes, Children).

-file("src/lustre/element/keyed.gleam", 152).
-spec 'div'(
    list(lustre@vdom@vattr:attribute(OYZ)),
    list({binary(), lustre@vdom@vnode:element(OYZ)})
...
-spec tbody(
    list(lustre@vdom@vattr:attribute(OZF)),
    list({binary(), lustre@vdom@vnode:element(OZF)})
) -> lustre@vdom@vnode:element(OZF).
tbody(Attributes, Children) ->
    element(<<"tbody"/utf8>>, Attributes, Children).

-file("src/lustre/element/keyed.gleam", 166).
-spec dl(
    list(lustre@vdom@vattr:attribute(OZL)),
    list({binary(), lustre@vdom@vnode:element(OZL)})
) -> lustre@vdom@vnode:element(OZL).
