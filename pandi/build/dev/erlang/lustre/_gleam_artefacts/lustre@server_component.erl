...
-spec element(
    list(lustre@vdom@vattr:attribute(QHH)),
    list(lustre@vdom@vnode:element(QHH))
...
-spec include(lustre@vdom@vattr:attribute(QHT), list(binary())) -> lustre@vdom@vattr:attribute(QHT).
...
-spec subject(lustre:runtime(QHX)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(QHX)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(QIF))
) -> lustre@runtime@server@runtime:message(QIF).
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(QIJ))
) -> lustre@runtime@server@runtime:message(QIJ).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(QIN)) -> nil)
) -> lustre@runtime@server@runtime:message(QIN).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(QIQ)) -> nil)
) -> lustre@runtime@server@runtime:message(QIQ).
...
-spec select(
    fun((fun((QIV) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(QIV))
) -> lustre@effect:effect(QIV).
select(Sel) ->
