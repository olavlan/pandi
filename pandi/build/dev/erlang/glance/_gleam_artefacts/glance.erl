...
-type definition(AAQ) :: {definition, list(attribute()), AAQ}.
...
-type bit_string_segment_option(AAR) :: bytes_option |
    int_option |
    float_option |
    bits_option |
    utf8_option |
...
-type record_update_field(AAS) :: {record_update_field,
        binary(),
        gleam@option:option(AAS)}.

-type variant_field() :: {labelled_variant_field, type(), binary()} |
    {unlabelled_variant_field, type()}.

-type field(AAT) :: {labelled_field, binary(), span(), AAT} |
    {shorthand_field, binary(), span()} |
    {unlabelled_field, AAT}.
...
-type parsed_list(AAU) :: {parsed_list,
        list(AAU),
        gleam@option:option(AAU),
        list({glexer@token:token(), glexer:position()}),
        integer()}.
...
-spec list(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {AHK, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    gleam@option:option(fun((span()) -> AHK)),
    list(AHK),
    list({glexer@token:token(), glexer:position()})
) -> {ok, parsed_list(AHK)} | {error, error()}.
...
-spec field(
    list({glexer@token:token(), glexer:position()}),
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {AJN, list({glexer@token:token(), glexer:position()})}} |
        {error, error()})
) -> {ok, {field(AJN), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
field(Tokens, Parser) ->
    case Tokens of
...
-spec comma_delimited(
    ...
    list({glexer@token:token(), glexer:position()}),
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {AIC, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    glexer@token:token()
) -> {ok,
        {list(AIC), integer(), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-spec bit_string_segment_options(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {AFH, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    list(bit_string_segment_option(AFH)),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
        {list(bit_string_segment_option(AFH)),
            list({glexer@token:token(), glexer:position()})}} |
...
-spec optional_bit_string_segment_options(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {AFA, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
        {list(bit_string_segment_option(AFA)),
            list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-spec bit_string_segment(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {AET, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
        {{AET, list(bit_string_segment_option(AET))},
            list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-spec delimited(
    ...
    list({glexer@token:token(), glexer:position()}),
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {AHA, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    glexer@token:token()
) -> {ok, {list(AHA), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-spec expect_name(
    list({glexer@token:token(), glexer:position()}),
    fun((binary(), list({glexer@token:token(), glexer:position()})) -> {ok, ABM} |
        {error, error()})
) -> {ok, ABM} | {error, error()}.
...
-spec until(
    ...
    ABR,
    list({glexer@token:token(), glexer:position()}),
    fun((ABR, list({glexer@token:token(), glexer:position()})) -> {ok,
            {ABR, list({glexer@token:token(), glexer:position()})}} |
        {error, error()})
) -> {ok, {ABR, integer(), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
